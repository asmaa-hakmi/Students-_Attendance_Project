...
pp.title = "Automobile Statistics Dashboard"
...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard"),#Include style for title
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            options=[
                {'label': 'Yearly Statistics', 'value':'Yearly Statistic'},
...
# Define the callback function to update the input container based on the selected statistics
@app.callback(
    Output(component_id='out-put-container', component_property='children'),
    [Input(component_id='dropdown-statistics', component_property='...'), Input(component_id='value', component_property='value')])
